...
<section class="newcar py-5">
    <div class="container">
        <div class="row">
            ...
            <p>Are you planning on buying a new car? Well, we know that with so many car options available out there, it gets really difficult to find a good car which suits your need. Hence, we have put together a complete list of new Bike. Maruti Suzuki, Tata and Toyota are the 3 most Electric car brands. These Electric car brands cater to a wide spectrum of budgets and needs, offering a variety of Bike from fuel-efficient hatchbacks to spacious SUVs. The 5 most Electric Bike are Nissan Magnite, Mahindra Thar Roxx, Tata Curvv, Tata Nexon and Honda Elevate. Explore the complete list of Bike by exploring different brands or by applying multiple filters such as budget, fuel type, body type etc. You can find the car that suits you best from the list of Bike below.</p>
            </div>
...
<section  class="b-auto">
    <div class="container">
        <div class="row">
             <div class="col-12">
                    <h2 class="s-title wow zoomInUp" data-wow-delay="0.3s">Bikes Brands </h2>
                ...
                <a href="#" class="btn m-btn btn-primarynew btn mt-5">View All Bike Brands</a>

    </div>
</section>
<section class="b-featured pt-5">
    <div class="container">
        <h2 class="s-title wow zoomInUp" data-wow-delay="0.3s">Electric Bikes </h2>
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                    <a href="#">
                        <img src="https://www.carbike360.com/_next/image?url=https%3A%2F%2Fs3.ap-south-1.amazonaws.com%2Fcb360static%2Fuploads%2Ff3490e8d-9cd8-420a-985c-f876cf80e2c7-small-New%2520Project%2520%252837%2529.webp&w=1920&q=75" alt="mers" />
